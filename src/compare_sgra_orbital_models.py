...
def plot_residuals(df, residuals, label):
    ...
    plot_path = f"validation/plots/{safe_label}_residuals_orbital_models.png"
    os.makedirs("validation/plots", exist_ok=True)
    plt.savefig(plot_path)
    return plot_path

def write_md_summary(source, features, score, plot_path, path="validation/axisw_sgra_orbital_models.md"):
